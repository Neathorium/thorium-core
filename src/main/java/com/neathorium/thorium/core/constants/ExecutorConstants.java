...
import com.neathorium.thorium.core.namespaces.executor.ExecutorFunctionDataFunctions;
...
public abstract class ExecutorConstants {
    ...
    public static final ExecuteParametersData DEFAULT_EXECUTION_DATA = new ExecuteParametersData(CommandRangeDataConstants.DEFAULT_RANGE, ExecutorFunctionDataFunctions::isAllDone, CoreFormatter::getExecutionEndMessage);
